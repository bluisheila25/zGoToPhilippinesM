    ...
    function E(f) {
        ...
        c.stop(1, 1).stop(1, 1).fadeOut(D.captionDuration / 3, function () {
			...
			if (ak=="Angeles"){
				...
				document.getElementById('TX').innerHTML=" Tagged as the Summer Capital of the Philippines and the City of Pines, Baguio City is the host of many popular destinations including hotels, historical and cultural centers, unique attractions and activities. It is considered one of the ancient places in the Philippines and since the time it has emerged as a profitable hub, influx of business and leisure tourists from across the world increased. Baguio is a cool, cloud-wreathed mountain paradise, an ideal holiday getaway that offers contrasting climate and scenery from the lowlands. And is considered a place where real extreme adventures begin!";
			}
			else if (ak=="Boracay"){
				document.getElementById('TX').innerHTML=" Widely known as one of the finest swimming destinations in the world, Boracay is blessed with unsullied fine talcum powder-sand beaches. Its tranquil crystal clear waters are perfect for swimming, sailing, fishing and sunbathing. Boracay also boasts of sapphire seas and spectacular sunsets. Countless hidden coves dot the island and tall coconut trees line up along the beaches.";
			}
			else if (ak=="Coron"){
				document.getElementById('TX').innerHTML=" An enchanting destination. A place traveler like you should include in your bucket list of places to visit. Coron is a small fishing village located southeast of the island of Busuanga, Palawan and opposite the island of Coron the ancestral homeland of the Tagbanuas. It is part of the Calamianes Group of Islands and located southwest of Mindoro Island, Philippines. It is also one of the best places in the world for wreck diving.";
			}
			else if (ak=="Cebu"){
				document.getElementById('TX').innerHTML=" It is the main center of commerce, trade and industry in the Visayas, it was recognized and named as the 7th Best Island Destination according to Conde Nast Traveler Magazine in the India-Asia region in 2007 and awarded as the 9th best Asian-Pacific Island Destination in 2009.";
			}
			else if (ak=="Ilocos"){
				document.getElementById('TX').innerHTML=" In Ilocos, one can easily find comfortable lodging to suit one's budget and needs. It is a very strong region that has impressive wide highways and stretches of thin paved roads, old-fashioned towns. A seemingly tempestuous sea rimmed with uneven rock formations and ascetic mountains are the two scenic images that first impress the visitors of Ilocos. People who live in Ilocos are industrious, cheerful, simple soul who has shown a remarkable strain of bravery and a bit of wanderlust that makes the guests of Ilocos feel at ease in staying in this place. Come and explore Ilocos as it proves that this is the real 'God's own paradise'";
			}
			else if (ak=="Makati"){
				document.getElementById('TX').innerHTML=" Makati is known for its developed business district, making it one of Asia’s important financial, commercial and economic centers, it is the financial capital of the country. Makati has become one of the well-known shopping destinations in Metro Manila, major shopping malls are Glorietta, Greenbelt and the Power Plant Mall. It is home to numerous hotels, condominiums and gated communities, it is notable for its exceptionally multicultural lifestyle significant center for intercontinental matters and for its reputation as a major entertainment center in the metropolis.";
			}
			else if (ak=="Manila"){
				document.getElementById('TX').innerHTML=" Manila is known as the National Capital Region, a thriving, ever- enlarging urban lounge and harboring a population of about ten million. Metro Manila is the financial, commercial and industrial center of the Philippines.";
			}
			else if (ak=="Puerto Galera"){
				document.getElementById('TX').innerHTML=" In the discreet north westernmost province of Oriental Mindoro rests Puerto Galera- your perfect backdrop to a very memorable getaway. With thick forests, limestone cliffs, white sand, crystal clear waters and private coves, Puerto Galera sceneries and activities give you an exciting vacation ever! This coastal town is internationally known for its nature, flora, fauna and marine wildlife especially the numerous pocket beaches and many snorkeling and Scuba diving spots.";
			}
			else if (ak=="Subic"){
				document.getElementById('TX').innerHTML=" Subic Bay is known for its diversity in culture, cuisine and leisure activities that makes an experience of a lifetime from panoramic views to extreme water sports activities. It belongs to the 1st class income classification, everything is here, let the cool breeze of Subic Bay welcomes you to the real paradise of its own. Adventure and relaxation, have it here in Subic Bay!";
			}
        })
    }
